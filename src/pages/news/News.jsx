  ...
  return (
    <div>
      <header className="main__header">
        <h1>Find Out The Latest Happening With U8</h1>
        <h3>
          ...
          <br/>
          Visit our website at <a href='www.u8gamers.com' alt="u8gamers">www.u8gamers.com</a> and discover the power of play like never before. Let's #GameOnTogether!
        </h3>
      </header>
